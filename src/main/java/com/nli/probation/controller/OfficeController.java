...
public class OfficeController {
  ...
  public ResponseEntity<ResponseModel> createOffice(
      @Valid @RequestBody CreateOfficeModel createModel) {
  ...
  public ResponseEntity<ResponseModel> updateOffice(
      @Valid @RequestBody UpdateOfficeModel requestModel) {
  ...
  public ResponseEntity<Object> searchOffices(
      @RequestPagingParam RequestPaginationModel requestPaginationModel,
      @RequestParam(value = "searchText", defaultValue = "") String searchText) {
    ResourceModel<OfficeModel> officeList = officeService.searchOffices(searchText,
