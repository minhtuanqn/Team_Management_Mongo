...
public class TeamService {
    ...
    private Example<TeamEntity> searchNameOrShortName(String searchValue) {
        ...
        ExampleMatcher exampleMatcher = ExampleMatcher.matchingAny()
                .withMatcher(TeamEntity_.NAME, ExampleMatcher.GenericPropertyMatchers.contains().ignoreCase())
                .withMatcher(TeamEntity_.SHORT_NAME, ExampleMatcher.GenericPropertyMatchers.contains().ignoreCase())
                .withMatcher(TeamEntity_.STATUS, ExampleMatcher.GenericPropertyMatchers.exact().ignoreCase())
    ...
    public ResourceModel<TeamModel> searchTeams(String searchValue, RequestPaginationModel paginationModel) {
        ...
        //Find all teams
        Page<TeamEntity> teamEntityPage = teamRepository.findAll(searchNameOrShortName(searchValue), pageable);
